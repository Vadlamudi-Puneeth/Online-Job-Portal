...
function HomeAfterLogin(){
    ...
    return(
        ...
        <div className="haf-image">

        <div className="three-button-container">

        <div class = "btnjobopen" >
            <button id="mock-test" onClick={handleMockTest} >Mock Test</button>
        </div>

        <div className="btn-mock-test" >
            <button id = "jobopen" onClick = {handleJobOpen} >Job Openings</button>
        </div>
        ...
        <div class= "rightcontent">
            <p id = "right">Welcome to Work Folio, your gateway to endless career opportunities. 
        ...
        <div class="getstarted">
            <button id = "get" onClick = {handleJobOpen} ><strong>Get Started</strong></button>
        </div>
